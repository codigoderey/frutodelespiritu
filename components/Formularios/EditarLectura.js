...
const NuevaLectura = ({ usuario, lectura }) => {
  ...
  const handleFormNuevaLectura = async (e) => {
    ...
    try {
      ...
      if (lecturaEditar.titulo === "" || lecturaEditar.resumen === "" || contenido === "" || categoria === "") {
        setErrorStatus(true)
      ...
      router.push(`${baseURL}/lecturas/lectura?slug=${nuevaLecturaEditar.slug}`)
    ...
    <>
      ...
      <form onSubmit={handleFormNuevaLectura} className="container p2 mb3">
        ...
        <div className="form-input-group">
          <input type="text" name="titulo" placeholder="Título" onChange={handleInputChange} defaultValue={lectura.titulo} />
        </div>

        <div className="form-input-group">
          <textarea type="text" name="resumen" placeholder="Resumen" onChange={handleInputChange} defaultValue={lectura.resumen} />
        </div>
