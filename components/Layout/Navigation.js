			...
			<div className="nav-bottom-links-container">
				...
				<div
					className={`${
						...
						router.pathname === '/lecturas/lectura' ||
						router.pathname === '/publicar/lectura' ||
						router.pathname === '/lecturas/categorias/reflexiones' ||
						router.pathname === '/lecturas/categorias/estudios-biblicos'
				...
				>
					...
					<Link href="/biblia/libros?id=592420522e16049f-01">
						<a>Biblia</a>
					</Link>
				</div>
				{!usuario ? (
					...
					>
						...
						<Link href="/perfil">
							<a className={`${router.pathname === '/perfil' && 'active'}`}>
								Perfil
							</a>
						</Link>
					</div>
