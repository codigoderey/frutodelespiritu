	...
	return (
		<>
			<Head>
				...
				<meta
					name="keywords"
					content="cristianismo, fruto del espiritu, la biblia, biblia en linea, dios, cristo, jesus, espiritu santo, escuela biblica"
				/>
...
MyApp.getInitialProps = async ({ Component, ctx }) => {
	...
	if (!token) {
		const isProtectedRoute =
			ctx.pathname === '/perfil' ||
			ctx.pathname === '/publicar/lectura' ||
			ctx.pathname === '/editar/lectura';
